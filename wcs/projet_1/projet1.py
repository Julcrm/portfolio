def afficher_wcs_projet1():
    ...
    test_items = [
        dict(
            title="",
            text="",
            img="wcs/projet_1/ressources/page 1.png"
            ),
        dict(
            title="",
            text="",
        img="wcs/projet_1/ressources/page 2.png"
        ),
        dict(
            title="",
            text="",
            img="wcs/projet_1/ressources/page 3.png"
            ),
        dict(
            title="",
            text="",
            img="wcs/projet_1/ressources/page 4.png"
        ),
